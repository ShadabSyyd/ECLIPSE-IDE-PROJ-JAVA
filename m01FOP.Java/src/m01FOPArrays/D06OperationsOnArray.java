...
public class D06OperationsOnArray{
	int[] arr;
	int size;
	int capacity;
	D06OperationsOnArray(int capacity){ // parameterized constructor
	...
	int deleteInEnd() {
		...
		arr[size-1] = 0; // make the last value of index to 0 and reduce the size by 1size--;
	...
	public static void main(String[] args) {
		D06OperationsOnArray ob = new D06OperationsOnArray(10);
		ob.insertInEnd(20);
		ob.insertInEnd(1);
		ob.insertInEnd(3);
		ob.insertInEnd(14);
